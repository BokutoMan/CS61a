...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    secend_num = opponent_score // 10 % 10
    the_ones = player_score % 10
    return max( 3 * abs(secend_num - the_ones) ,1)
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    "*** YOUR CODE HERE ***"
    bigest_avg_sco = 0
    low_num_to_get_sco = 0
    averaged_dice = make_averaged(roll_dice, times_called)
    for i in range(1, 11):
        avg_sco = averaged_dice(i, dice)
        if avg_sco > bigest_avg_sco:
            bigest_avg_sco = avg_sco
            low_num_to_get_sco = i
    return low_num_to_get_sco
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return sus_strategy(score, opponent_score, threshold=GOAL-score)
    # END PROBLEM 12
